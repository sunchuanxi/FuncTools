	...
	, productID(productID)
{
	if (index == 0)
	{
		...
		char net1[200] = "./model2/quejiao.model";
		char net2[200] = "./model2/huahen.model";
		char net3[200] = "./model2/zangwu.model";
		...
		//	pSeg[i] = new SuaKIT::API::SegmentationEvaluator(netWrokPathList[i].c_str(), deviceDescArray.GetAt(0), networkH, networkW, networkC);
		//	//qWarning() << __LINE__;
